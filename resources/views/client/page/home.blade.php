				...
				<div class="row">
					...
					<!-- shop -->
						<div class="col-md-4 col-xs-6">
							<div class="shop">
								<div class="shop-img">
									<img src="/uploads/collection_imgs/{{ $collection->image }}" alt="">
								</div>
								<div class="shop-body">
									<h3>   Bộ sưu tập <br> {{ $collection->name }}</h3>
					...
					<div class="col-md-4 col-xs-6">
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./store/img/product04.png" alt="">
									</div>
									<div class="product-body">
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./store/img/product05.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
								...
								<div class="product-widget">
									<div class="product-img">
										<img src="./store/img/product06.png" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
